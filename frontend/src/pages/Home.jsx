...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-stone-50">
      {/* Header/Navigation */}
      <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md shadow-sm z-50 border-b border-amber-100">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-stone-900">Royalhouse Chapel</h1>
                <p className="text-xs text-amber-700">Kent Mission</p>
              </div>
            </div>
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#vision" className="text-stone-700 hover:text-amber-700 transition-colors font-medium">Vision</a>
              <a href="#prayer" className="text-stone-700 hover:text-amber-700 transition-colors font-medium">Prayer</a>
              <a href="#connect" className="text-stone-700 hover:text-amber-700 transition-colors font-medium">Connect</a>
            </nav>
          </div>
        </div>
      </header>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-stone-900 leading-tight">
                A Place Where You
                <span className="block text-amber-700">Belong & Grow</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-2 border-amber-600 text-amber-700 hover:bg-amber-50 transition-all"
            ...
            <div className="relative">
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-amber-200 to-amber-400 overflow-hidden shadow-2xl">
                <img 
              ...
              <div className="absolute -bottom-6 -left-6 w-48 h-48 bg-amber-600/10 rounded-3xl -z-10"></div>
              <div className="absolute -top-6 -right-6 w-48 h-48 bg-amber-600/10 rounded-3xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-20 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">About Us</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-amber-100 hover:border-amber-300 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-amber-50">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-stone-900">Christ-Centered</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-2 border-amber-100 hover:border-amber-300 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-amber-50">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-stone-900">Bible-Believing</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-stone-600 text-base">
            ...
            <Card className="border-2 border-amber-100 hover:border-amber-300 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-amber-50">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-stone-900">Community Impact</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-stone-600 text-base">
      ...
      <section id="vision" className="py-20 px-4 bg-gradient-to-br from-amber-50 to-stone-50">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <Card className="border-2 border-amber-200 shadow-xl bg-white">
              ...
              <CardContent className="pt-8">
                <p className="text-2xl font-semibold text-stone-900 leading-relaxed">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-amber-700 to-amber-800 text-white">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <Button 
            size="lg" 
            className="bg-white text-amber-800 hover:bg-amber-50 font-bold text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all"
            onClick={() => document.getElementById('connect').scrollIntoView({ behavior: 'smooth' })}
          >
      ...
      <section id="prayer" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">Need Prayer?</h2>
            <p className="text-lg text-stone-600 leading-relaxed">
          ...
          <Card className="border-2 border-amber-200 shadow-xl">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-stone-50">
              <CardTitle className="text-2xl text-stone-900">Submit Your Prayer Request</CardTitle>
            ...
            <CardContent className="pt-6">
              <form onSubmit={handlePrayerSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all"
                >
      ...
      {/* Connect Section */}
      <section id="connect" className="py-20 px-4 bg-gradient-to-br from-amber-50 to-stone-50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">Connect With Us</h2>
            <p className="text-lg text-stone-600 leading-relaxed">
          ...
          <Card className="border-2 border-amber-200 shadow-xl">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-stone-50">
              <CardTitle className="text-2xl text-stone-900">Get Connected</CardTitle>
              <CardDescription className="text-base">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-b from-stone-900 to-stone-950 text-white py-16 px-4">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-400">Kent Mission</p>
                </div>
              </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-6 text-amber-400">Visit Us</h4>
              <div className="space-y-4">
                <div className="flex gap-3">
                  <MapPin className="w-5 h-5 text-amber-500 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-stone-300">Northfleet Technology College</p>
                    <p className="text-stone-400 text-sm">Colyer Rd, Northfleet</p>
                    <p className="text-stone-400 text-sm">Gravesend DA11 8BG</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <Mail className="w-5 h-5 text-amber-500 flex-shrink-0" />
                  <a href="mailto:rcikentmission@gmail.com" className="text-stone-300 hover:text-amber-400 transition-colors">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  className="w-12 h-12 bg-stone-800 hover:bg-amber-700 rounded-full flex items-center justify-center transition-all hover:scale-110"
                >
